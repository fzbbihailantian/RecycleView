...
public class DividerItemDecoration_br_disappear extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration_br_disappear(Context context, int orientation,int spancount) {
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount ; ++i) {
            if (spancount>-1&&(i+1)%spancount==0)continue;
            View child = parent.getChildAt(i);
